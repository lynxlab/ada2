...
<html>
    ...
    <body>
        ...
        <div style="position:absolute; width:100%; top:0.9em; text-align: center;">
            <img style="max-height:30px;" src="img/logo_enjoy.png">
        </div>
        ...
        max-height:3.8em; overflow: hidden; text-align:center; margin: 2.5em 0; font-weight:bold; font-size:2.2em;">
        ...
        <div class="course_title" style=" max-height: 5em; overflow: hidden; margin: 1.5em 0; font-weight:bold;">
        ...
        <div style="position:absolute; width:100%; bottom:4.8em; text-align: right; page-break-after: auto;">
