...
--
-- Struttura della tabella `module_jitsi_meeting`
--

CREATE TABLE `module_jitsi_meeting` (
  `openmeetings_room_id` int(11) UNSIGNED NOT NULL,
  `meetingID` varchar(50) COLLATE utf8_unicode_ci NOT NULL
...
--
-- Indici per le tabelle `module_jitsi_meeting`
--
ALTER TABLE `module_jitsi_meeting`
