    ...
    <body>
						...
						<div class="ui form basic segment">
								...
								<div class="two fields">
								    <div class="field">
								      <div class="ui fluid helptype selection dropdown">
								        <div class="placeholder text"><i18n>Seleziona il tipo di richiesta</i18n>...</div>
	                        ...
	                        <div class="ui bottom attached right aligned header">	                        
								<div class="ui blue submit right icon labeled button">
									<i class="mail outline icon"></i><i18n>Invia</i18n>
								</div>			
							</div>			
        ...
        <div id="messagesContainer">
        	...
        	<div class="ui modal" id="modalSentOK">
    			<div class="header"><i18n>Richiesta di assistenza inviata</div>
    			<div class="content">
