...
/**
 * @author giorgio 28/lug/2014
 * 
 * added check if commento_field is undefined
 */
if (typeof commento_field != 'undefined') {
...
function FCKeditor_OnComplete( fckEditor )
{
	if (fckEditor.Name == 'testo') {
		 ...
		 * @author giorgio 28/lug/2014
		 * 
		 * added check if injectTemplate_field is undefined
		 */
		if (typeof injectTemplate_field != 'undefined') {
